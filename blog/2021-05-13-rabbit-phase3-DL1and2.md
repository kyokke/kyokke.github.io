...
　- Stage.1,2 動画は基本座学だった(コードが動画でとりあげられなかった)ため、一通り動画を見てからまとめを行ったが、Stage.3 では動画講義中にもコードを見る・動かすシーンが多発しそうなため、ずっとエディタにカーソルあたってたほうがいいや、動画を見ながらレポートをまとめつつ、コードも実行しつつのスタイルですすめる。
...
- 5/23: Day2 Section 2 (1.75h) 
- 5/25: Day2 Section 3 (1.75h) 


- 5/26: Day2 Section 4 (2h) 
- 5/27: Day2 Section 5 (2h) 
- 5/29: テスト(1h)
